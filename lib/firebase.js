...
export const getChatPairKey = (userA, userB) => {
 ...
 export { rtdb,db,database, storage, push, update, get, set, ref, off, onValue, storageBackup,storageBackup1};//,db, storage,   auth, signInWithEmailAndPassword, signInWithPopup,  createUserWithEmailAndPassword, GoogleAuthProvider
