...
export { getToken, onMessage };
 ...
 export { rtdb,db,database, storage, push, update, get, set, ref, off, onValue,  onDisconnect, serverTimestamp, storageBackup,storageBackup1};//,db, storage,   auth, signInWithEmailAndPassword, signInWithPopup,  createUserWithEmailAndPassword, GoogleAuthProvider
