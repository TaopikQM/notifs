...
import { ref, get, onValue, off, database } from "../lib/firebase";
import { getChatPairKey, formatLastSeen, setUserOnline, setUserOffline, getUserPresence, startHeartbeat } from "../lib/firebase";
...
export default function ChatPage() {
  ...
  // 2. Presence & Heartbeat (Online/Offline)
  useEffect(() => {
    if (!userId) return;
  ...
  const handleSendMessage = async (e) => {
    e.preventDefault();
    if (!messageInput.trim() || !userId || !otherUser || !isChatUnlocked) return;
